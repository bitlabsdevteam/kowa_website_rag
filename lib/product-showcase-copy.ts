...
export const PRODUCT_FAMILY_COPY: Record<Locale, Record<ProductFamily, ProductFamilyCopy>> = {
  en: {
    'abs-crushed': {
      ...
      summary:
        'Post-industrial ABS scrap sorted and crushed into a reusable regrind feedstock, an early-stage output of Kowa’s collection-to-regeneration recycling flow.',
      points: ['Sorted by resin type', 'Crushed, regeneration-ready regrind', 'Circular, resource-recovery sourced'],
    },
    'hdpe-crushed': {
      title: 'HDPE Regrind',
      material: 'Crushed high-density polyethylene (HDPE)',
      summary:
        'Recovered HDPE scrap sorted and crushed into a reusable regrind feedstock ahead of pellet reprocessing, handled through Kowa’s circular sort-and-process flow.',
      points: ['Sorted by resin type', 'Crushed, regeneration-ready regrind', 'Circular, resource-recovery sourced'],
    },
    'hips-crushed': {
      title: 'HIPS Regrind',
      ...
      summary:
        'Recovered HIPS scrap sorted and crushed into a reusable regrind feedstock ahead of pellet reprocessing, handled through Kowa’s circular sort-and-process flow.',
      points: ['Sorted by resin type', 'Crushed, regeneration-ready regrind', 'Circular, resource-recovery sourced'],
    },
    'pp-crushed': {
      title: 'PP Regrind',
      ...
      summary:
        'Recovered PP scrap sorted and crushed into a reusable regrind feedstock ahead of pellet reprocessing, handled through Kowa’s circular sort-and-process flow.',
      points: ['Sorted by resin type', 'Crushed, regeneration-ready regrind', 'Circular, resource-recovery sourced'],
    },
    'gpps-pellet': {
  ...
  ja: {
    'abs-crushed': {
      ...
      summary: '選別・破砕された ABS リグラインド原料。広和の回収から再生までの循環フローにおける初期工程のアウトプットです。',
      points: ['樹脂別に選別', '再生対応のリグラインド原料', '循環型の資源回収由来'],
    },
    'hdpe-crushed': {
      title: 'HDPE リグラインド',
      material: '破砕 HDPE（高密度ポリエチレン）',
      summary: '選別・破砕された HDPE リグラインド原料。広和の循環型の選別・処理フローで回収し、ペレット再加工の前段階として扱います。',
      points: ['樹脂別に選別', '再生対応のリグラインド原料', '循環型の資源回収由来'],
    },
    'hips-crushed': {
      title: 'HIPS リグラインド',
      material: '破砕 HIPS（耐衝撃性ポリスチレン）',
      summary: '選別・破砕された HIPS リグラインド原料。広和の循環型の選別・処理フローで回収し、ペレット再加工の前段階として扱います。',
      points: ['樹脂別に選別', '再生対応のリグラインド原料', '循環型の資源回収由来'],
    },
    'pp-crushed': {
      title: 'PP リグラインド',
      material: '破砕 PP（ポリプロピレン）',
      summary: '選別・破砕された PP リグラインド原料。広和の循環型の選別・処理フローで回収し、ペレット再加工の前段階として扱います。',
      points: ['樹脂別に選別', '再生対応のリグラインド原料', '循環型の資源回収由来'],
    },
    'gpps-pellet': {
      title: 'GPPS 再加工ペレット',
  ...
  'zh-Hans': {
    'abs-crushed': {
      ...
      summary: '经分拣、破碎的 ABS 再研磨料，是 广和从回收到再生循环流程中的早期阶段产出。',
      points: ['按树脂类型分拣', '可直接再生的再研磨原料', '循环资源回收来源'],
    },
    'hdpe-crushed': {
      title: 'HDPE 再研磨料',
      material: '破碎 HDPE（高密度聚乙烯）',
      summary: '经分拣、破碎的 HDPE 再研磨料，通过 广和的循环分拣与处理流程回收，作为颗粒再加工前段的原料。',
      points: ['按树脂类型分拣', '可直接再生的再研磨原料', '循环资源回收来源'],
    },
    'hips-crushed': {
      title: 'HIPS 再研磨料',
      material: '破碎 HIPS（高抗冲聚苯乙烯）',
      summary: '经分拣、破碎的 HIPS 再研磨料，通过 广和的循环分拣与处理流程回收，作为颗粒再加工前段的原料。',
      points: ['按树脂类型分拣', '可直接再生的再研磨原料', '循环资源回收来源'],
    },
    'pp-crushed': {
      title: 'PP 再研磨料',
      material: '破碎 PP（聚丙烯）',
      summary: '经分拣、破碎的 PP 再研磨料，通过 广和的循环分拣与处理流程回收，作为颗粒再加工前段的原料。',
      points: ['按树脂类型分拣', '可直接再生的再研磨原料', '循环资源回收来源'],
    },
    'gpps-pellet': {
      title: 'GPPS 再加工颗粒',
  ...
  'zh-Hant': {
    'abs-crushed': {
      title: 'ABS 再研磨料',
      material: '破碎 ABS（丙烯腈丁二烯苯乙烯）',
      summary: '經分揀、破碎的 ABS 再研磨料，是 廣和從回收到再生循環流程中的早期階段產出。',
      points: ['按樹脂類型分揀', '可直接再生的再研磨原料', '循環資源回收來源'],
    },
    'hdpe-crushed': {
      title: 'HDPE 再研磨料',
      material: '破碎 HDPE（高密度聚乙烯）',
      summary: '經分揀、破碎的 HDPE 再研磨料，通過 廣和的循環分揀與處理流程回收，作為顆粒再加工前段的原料。',
      points: ['按樹脂類型分揀', '可直接再生的再研磨原料', '循環資源回收來源'],
    },
    'hips-crushed': {
      title: 'HIPS 再研磨料',
      material: '破碎 HIPS（高抗衝聚苯乙烯）',
      summary: '經分揀、破碎的 HIPS 再研磨料，通過 廣和的循環分揀與處理流程回收，作為顆粒再加工前段的原料。',
      points: ['按樹脂類型分揀', '可直接再生的再研磨原料', '循環資源回收來源'],
    },
    'pp-crushed': {
      title: 'PP 再研磨料',
      material: '破碎 PP（聚丙烯）',
      summary: '經分揀、破碎的 PP 再研磨料，通過 廣和的循環分揀與處理流程回收，作為顆粒再加工前段的原料。',
      points: ['按樹脂類型分揀', '可直接再生的再研磨原料', '循環資源回收來源'],
    },
    'gpps-pellet': {
      title: 'GPPS 再加工顆粒',
