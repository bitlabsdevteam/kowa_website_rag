...
export const PRODUCT_FAMILY_COPY: Record<Locale, Record<ProductFamily, ProductFamilyCopy>> = {
  ...
  ja: {
    'abs-crushed': {
      ...
      summary: '選別・破砕された ABS リグラインド原料。Kowa の回収から再生までの循環フローにおける初期工程のアウトプットです。',
      points: ['樹脂別に選別', '再生対応のリグラインド原料', '循環型の資源回収由来'],
    },
    'hdpe-crushed': {
      title: 'HDPE リグラインド',
      material: '破砕 HDPE（高密度ポリエチレン）',
      summary: '選別・破砕された HDPE リグラインド原料。Kowa の循環型の選別・処理フローで回収し、ペレット再加工の前段階として扱います。',
      points: ['樹脂別に選別', '再生対応のリグラインド原料', '循環型の資源回収由来'],
    },
    'hips-crushed': {
      title: 'HIPS リグラインド',
      material: '破砕 HIPS（耐衝撃性ポリスチレン）',
      summary: '選別・破砕された HIPS リグラインド原料。Kowa の循環型の選別・処理フローで回収し、ペレット再加工の前段階として扱います。',
      points: ['樹脂別に選別', '再生対応のリグラインド原料', '循環型の資源回収由来'],
    },
    'pp-crushed': {
      title: 'PP リグラインド',
      material: '破砕 PP（ポリプロピレン）',
      summary: '選別・破砕された PP リグラインド原料。Kowa の循環型の選別・処理フローで回収し、ペレット再加工の前段階として扱います。',
      points: ['樹脂別に選別', '再生対応のリグラインド原料', '循環型の資源回収由来'],
    },
    'gpps-pellet': {
      title: 'GPPS 再加工ペレット',
      material: '汎用ポリスチレン（GPPS）',
      summary: '回収した GPPS を Kowa の再加工ラインでペレット形状へ仕上げ、次工程や供給に接続します。',
      points: ['ペレット向け仕上げ', '安定した下流供給', '再加工材の見える化'],
    },
    'hdpe-pellet': {
      title: 'HDPE 再加工ペレット',
      material: '高密度ポリエチレン（HDPE）',
      summary: '回収した HDPE を Kowa の再加工ラインでペレット形状へ仕上げ、次工程や供給に接続します。',
      points: ['ペレット向け仕上げ', '安定した下流供給', '再加工材の見える化'],
    },
    'pc-pellet': {
      title: 'rPC ペレット（ボトルグレード）',
      material: '再生ポリカーボネート（rPC）ボトルグレード',
      summary: '回収したポリカーボネートを Kowa の再加工ラインでボトルグレードのペレット形状へ仕上げ、次工程や供給に接続します。',
      points: ['ボトルグレード仕上げ', '安定した下流供給', '再加工材の見える化'],
    },
    'pcr-pellet': {
      title: 'rPC ペレット（CDグレード）',
      material: '再生ポリカーボネート（rPC）CDグレード',
      summary: '回収したポリカーボネートを Kowa の再加工ラインでCDグレードのペレット形状へ仕上げ、次工程や供給に接続します。',
      points: ['CDグレード仕上げ', '安定した下流供給', '再加工材の見える化'],
    },
    'pir-pellet': {
      title: 'アクリル再加工ペレット',
      material: '再生アクリル（PMMA）',
      summary: '回収したアクリル（PMMA）を Kowa の再加工ラインでペレット形状へ仕上げ、次工程や供給に接続します。',
      points: ['ペレット向け仕上げ', '安定した下流供給', '再加工材の見える化'],
    },
    'pp-pellet': {
      title: 'PP 再加工ペレット',
      material: 'ポリプロピレン（PP）',
      summary: '回収した PP を Kowa の再加工ラインでペレット形状へ仕上げ、次工程や供給に接続します。',
      points: ['ペレット向け仕上げ', '安定した下流供給', '再加工材の見える化'],
    },
    'ps-pellet': {
      title: 'HIPS 再加工ペレット',
      material: '耐衝撃性ポリスチレン（HIPS）',
      summary: '回収した HIPS を Kowa の再加工ラインでペレット形状へ仕上げ、次工程や供給に接続します。',
      points: ['ペレット向け仕上げ', '安定した下流供給', '再加工材の見える化'],
    },
    'rpp-pellet': {
      title: 'rPP ペレット',
    ...
    'rabs-pellet': {
      ...
      summary: '回収した ABS を Kowa の再加工ラインでペレット形状へ仕上げ、次工程や供給に接続します。',
      points: ['ペレット向け仕上げ', '安定した下流供給', '再加工材の見える化'],
    },
    'general-goods-moisture-charcoal': {
      title: '調湿木炭',
  ...
  'zh-Hans': {
    'abs-crushed': {
      ...
      summary: '经分拣、破碎的 ABS 再研磨料，是 Kowa 从回收到再生循环流程中的早期阶段产出。',
      points: ['按树脂类型分拣', '可直接再生的再研磨原料', '循环资源回收来源'],
    },
    'hdpe-crushed': {
      title: 'HDPE 再研磨料',
      material: '破碎 HDPE（高密度聚乙烯）',
      summary: '经分拣、破碎的 HDPE 再研磨料，通过 Kowa 的循环分拣与处理流程回收，作为颗粒再加工前段的原料。',
      points: ['按树脂类型分拣', '可直接再生的再研磨原料', '循环资源回收来源'],
    },
    'hips-crushed': {
      title: 'HIPS 再研磨料',
      material: '破碎 HIPS（高抗冲聚苯乙烯）',
      summary: '经分拣、破碎的 HIPS 再研磨料，通过 Kowa 的循环分拣与处理流程回收，作为颗粒再加工前段的原料。',
      points: ['按树脂类型分拣', '可直接再生的再研磨原料', '循环资源回收来源'],
    },
    'pp-crushed': {
      title: 'PP 再研磨料',
      material: '破碎 PP（聚丙烯）',
      summary: '经分拣、破碎的 PP 再研磨料，通过 Kowa 的循环分拣与处理流程回收，作为颗粒再加工前段的原料。',
      points: ['按树脂类型分拣', '可直接再生的再研磨原料', '循环资源回收来源'],
    },
    'gpps-pellet': {
      title: 'GPPS 再加工颗粒',
      material: '通用聚苯乙烯（GPPS）',
      summary: '回收的 GPPS 经 Kowa 再加工产线整理为颗粒形态，衔接后续供应与混配。',
      points: ['颗粒化整理', '稳定下游供给', '再加工材料展示'],
    },
    'hdpe-pellet': {
      title: 'HDPE 再加工颗粒',
      material: '高密度聚乙烯（HDPE）',
      summary: '回收的 HDPE 经 Kowa 再加工产线整理为颗粒形态，衔接后续供应与混配。',
      points: ['颗粒化整理', '稳定下游供给', '再加工材料展示'],
    },
    'pc-pellet': {
      title: 'rPC 颗粒（瓶级）',
      material: '再生聚碳酸酯（rPC）瓶级',
      summary: '回收的聚碳酸酯经 Kowa 再加工产线整理为瓶级颗粒形态，衔接后续供应与混配。',
      points: ['瓶级颗粒整理', '稳定下游供给', '再加工材料展示'],
    },
    'pcr-pellet': {
      title: 'rPC 颗粒（CD级）',
      material: '再生聚碳酸酯（rPC）CD级',
      summary: '回收的聚碳酸酯经 Kowa 再加工产线整理为CD级颗粒形态，衔接后续供应与混配。',
      points: ['CD级颗粒整理', '稳定下游供给', '再加工材料展示'],
    },
    'pir-pellet': {
      title: '亚克力再加工颗粒',
      material: '再生亚克力（PMMA）',
      summary: '回收的亚克力（PMMA）经 Kowa 再加工产线整理为颗粒形态，衔接后续供应与混配。',
      points: ['颗粒化整理', '稳定下游供给', '再加工材料展示'],
    },
    'pp-pellet': {
      title: 'PP 再加工颗粒',
      material: '聚丙烯（PP）',
      summary: '回收的 PP 经 Kowa 再加工产线整理为颗粒形态，衔接后续供应与混配。',
      points: ['颗粒化整理', '稳定下游供给', '再加工材料展示'],
    },
    'ps-pellet': {
      title: 'HIPS 再加工颗粒',
      material: '高抗冲聚苯乙烯（HIPS）',
      summary: '回收的 HIPS 经 Kowa 再加工产线整理为颗粒形态，衔接后续供应与混配。',
      points: ['颗粒化整理', '稳定下游供给', '再加工材料展示'],
    },
    'rpp-pellet': {
      title: 'rPP 颗粒',
    ...
    'rabs-pellet': {
      ...
      summary: '回收的 ABS 经 Kowa 再加工产线整理为颗粒形态，衔接后续供应与混配。',
      points: ['颗粒化整理', '稳定下游供给', '再加工材料展示'],
    },
    'general-goods-moisture-charcoal': {
      title: '调湿木炭',
  ...
  'zh-Hant': {
    'abs-crushed': {
      title: 'ABS 再研磨料',
      material: '破碎 ABS（丙烯腈丁二烯苯乙烯）',
      summary: '經分揀、破碎的 ABS 再研磨料，是 Kowa 從回收到再生循環流程中的早期階段產出。',
      points: ['按樹脂類型分揀', '可直接再生的再研磨原料', '循環資源回收來源'],
    },
    'hdpe-crushed': {
      title: 'HDPE 再研磨料',
      material: '破碎 HDPE（高密度聚乙烯）',
      summary: '經分揀、破碎的 HDPE 再研磨料，通過 Kowa 的循環分揀與處理流程回收，作為顆粒再加工前段的原料。',
      points: ['按樹脂類型分揀', '可直接再生的再研磨原料', '循環資源回收來源'],
    },
    'hips-crushed': {
      title: 'HIPS 再研磨料',
      material: '破碎 HIPS（高抗衝聚苯乙烯）',
      summary: '經分揀、破碎的 HIPS 再研磨料，通過 Kowa 的循環分揀與處理流程回收，作為顆粒再加工前段的原料。',
      points: ['按樹脂類型分揀', '可直接再生的再研磨原料', '循環資源回收來源'],
    },
    'pp-crushed': {
      title: 'PP 再研磨料',
      material: '破碎 PP（聚丙烯）',
      summary: '經分揀、破碎的 PP 再研磨料，通過 Kowa 的循環分揀與處理流程回收，作為顆粒再加工前段的原料。',
      points: ['按樹脂類型分揀', '可直接再生的再研磨原料', '循環資源回收來源'],
    },
    'gpps-pellet': {
      title: 'GPPS 再加工顆粒',
      material: '通用聚苯乙烯（GPPS）',
      summary: '回收的 GPPS 經 Kowa 再加工產線整理為顆粒形態，銜接後續供應與混配。',
      points: ['顆粒化整理', '穩定下游供給', '再加工材料展示'],
    },
    'hdpe-pellet': {
      title: 'HDPE 再加工顆粒',
      material: '高密度聚乙烯（HDPE）',
      summary: '回收的 HDPE 經 Kowa 再加工產線整理為顆粒形態，銜接後續供應與混配。',
      points: ['顆粒化整理', '穩定下游供給', '再加工材料展示'],
    },
    'pc-pellet': {
      title: 'rPC 顆粒（瓶級）',
      material: '再生聚碳酸酯（rPC）瓶級',
      summary: '回收的聚碳酸酯經 Kowa 再加工產線整理為瓶級顆粒形態，銜接後續供應與混配。',
      points: ['瓶級顆粒整理', '穩定下游供給', '再加工材料展示'],
    },
    'pcr-pellet': {
      title: 'rPC 顆粒（CD級）',
      material: '再生聚碳酸酯（rPC）CD級',
      summary: '回收的聚碳酸酯經 Kowa 再加工產線整理為CD級顆粒形態，銜接後續供應與混配。',
      points: ['CD級顆粒整理', '穩定下游供給', '再加工材料展示'],
    },
    'pir-pellet': {
      title: '亞克力再加工顆粒',
      material: '再生亞克力（PMMA）',
      summary: '回收的亞克力（PMMA）經 Kowa 再加工產線整理為顆粒形態，銜接後續供應與混配。',
      points: ['顆粒化整理', '穩定下游供給', '再加工材料展示'],
    },
    'pp-pellet': {
      title: 'PP 再加工顆粒',
      material: '聚丙烯（PP）',
      summary: '回收的 PP 經 Kowa 再加工產線整理為顆粒形態，銜接後續供應與混配。',
      points: ['顆粒化整理', '穩定下游供給', '再加工材料展示'],
    },
    'ps-pellet': {
      title: 'HIPS 再加工顆粒',
      material: '高抗衝聚苯乙烯（HIPS）',
      summary: '回收的 HIPS 經 Kowa 再加工產線整理為顆粒形態，銜接後續供應與混配。',
      points: ['顆粒化整理', '穩定下游供給', '再加工材料展示'],
    },
    'rpp-pellet': {
      title: 'rPP 顆粒',
    ...
    'rabs-pellet': {
      title: 'rABS 顆粒',
      material: '再生ABS（丙烯腈丁二烯苯乙烯）',
      summary: '回收的 ABS 經 Kowa 再加工產線整理為顆粒形態，銜接後續供應與混配。',
      points: ['顆粒化整理', '穩定下游供給', '再加工材料展示'],
    },
    'general-goods-moisture-charcoal': {
      title: '調濕木炭',
