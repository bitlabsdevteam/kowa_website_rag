...
test('v9 task16: homepage has no legacy fact block labels in footer area', async ({ page }) => {
  await page.goto('/');
  ...
  await page.screenshot({
    path: 'tests/screenshots/task16-step1-v9-homepage-legacy-fact-block-removal.png',
    fullPage: true,
  });
});
