...
test('v17 task2: landing page no longer renders the Talk to Aya chat trigger', async ({ page }) => {
  ...
  await page.screenshot({ path: 'tests/screenshots/task2-01-landing-initial.png', fullPage: true });
  ...
  await page.screenshot({ path: 'tests/screenshots/task2-02-hero-without-aya.png', fullPage: true });
});
