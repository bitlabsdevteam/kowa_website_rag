...
- [x] Task 12: Publish v10 walkthrough and validation evidence (P2)
  ...
  - Completed: 2026-04-02 - Published v10 walkthrough with build/lint, full v10 unit regression (`33 passed`), semgrep, and npm audit evidence.
