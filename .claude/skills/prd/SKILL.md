---
name: prd
description: Brainstorm requirements and create sprint PRDs with atomic tasks. Use when starting a new sprint, defining requirements, or planning a project's next iteration.
---
