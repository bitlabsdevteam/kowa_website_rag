---
name: walkthrough
description: Generate a sprint review report (WALKTHROUGH.md) documenting exactly what was built in the current sprint. Use at the end of a sprint or when asked to document sprint work.
---
