// The recycling-line diorama artwork — the SVG body shared by the static
// FactoryPoster fallback and the mobile FactoryStory scroll pan. Same
// composition and FACTORY_PALETTE hexes as factory-scene.tsx, hand-drawn as
// one flat SVG fragment (no hooks — render inside any <svg viewBox="0 0 1200
// 675">). STORY_ANCHORS in factory-story-math.ts index into these
// coordinates; keep machine positions in sync with that table.
...
export function FactoryDioramaArt() {
  return (
    <>
      <defs>
